define([
    'react', 'jsx!components/Body','reactDnd', 'reactdndhtml5backend','react-progress-bar-plus','react-dropzone','toastr','config','react-loading','bootstrap'
], function(React, Body,  ReactDND, HTML5Backend, ProgressBar, Dropzone, toastr,config,Loader) {
